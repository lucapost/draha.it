		...
		<div id="top" class="container_12">
			<div id="social" class="grid_3 prefix_1">	
				...
				<a href="http://twitter.com/share" class="twitter-share-button"
					...
					data-count="none">
				Tweet</a> 
				<iframe src="https://www.facebook.com/plugins/like.php?href=https://www.facebook.com/pages/Casa-Vacanze-Draha-BB-Oasi-di-Pace/171844799548891?sk=wall" style="border:none; width:50px; height:20px"></iframe>
			</div>
