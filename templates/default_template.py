    ...
    return '''
		...
		<footer class="container_12 clearfix">
			<div class="grid_3">
				...
				<a href="/#tripadvisor" title="scrivi una recensione su Casa Draha"><img src="/images/tripadvisor.png" alt="tripadvisor logo" title="scrivi una recensione su Casa Draha" class="tripadvisor"/></a>
			</div>
			<div class="grid_6">
