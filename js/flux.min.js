...
function(a){a.preventDefault();c.prev()});e=(this.height-this.nextButton.height())/2;this.nextButton.css({top:e+"px",right:"10px"});this.prevButton.css({top:e+"px",left:"10px"})}if(this.options.captions)this.captionBar=b('<div class="caption"></div>').css({background:"rgba(0,0,0,0.7)",color:"#FFF","font-size":"16px","font-family":"Josefin Sans, helvetica, arial, sans-serif","font-weight":"bold","text-decoration":"none","text-transform":"uppercase",padding:"120px 0 0 5px",opacity:0,position:"absolute","z-index":110,width:"100%",bottom:0}).css3({"transition-property":"opacity",
